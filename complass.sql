...
CREATE TABLE `review_tasks` (
  ...
  `use_coze` tinyint(1) NOT NULL DEFAULT '1',
  `rule_version_id` varchar(36) DEFAULT NULL,
  `rules_snapshot_json` json DEFAULT NULL,
  `contract_type` varchar(50) NOT NULL DEFAULT '通用',
  `sanitization_mapping_json` json DEFAULT NULL,
  `sanitization_status` varchar(20) NOT NULL DEFAULT 'not_required',
...
CREATE TABLE `comparison_tasks` (
  ...
  `token_cost` int DEFAULT NULL,
  `enhance` tinyint(1) NOT NULL DEFAULT '1',
  `rule_version_id` varchar(36) DEFAULT NULL,
  `rules_snapshot_json` json DEFAULT NULL,
  `contract_type` varchar(50) NOT NULL DEFAULT '通用',
  `old_sanitization_mapping_json` json DEFAULT NULL,
  `new_sanitization_mapping_json` json DEFAULT NULL,
  `sanitization_status` varchar(20) NOT NULL DEFAULT 'not_required',
  `sanitization_error` text,
  `old_file_path` varchar(500) DEFAULT NULL,
  `new_file_path` varchar(500) DEFAULT NULL,
